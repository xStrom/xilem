...
pub(crate) struct WidgetState {
    ...
    /// The widget's visual border-box in the widget's border-box coordinate space.
    ///
...
impl WidgetState {
    ...
    /// Returns the widget's layout border-box rect in the widget's border-box coordinate space.
    pub(crate) fn layout_border_box(&self) -> Rect {
        self.layout_border_box_size.to_rect()
    }

    /// Returns the widget's layout paint-box rect in the widget's border-box coordinate space.
    pub(crate) fn layout_paint_box(&self) -> Rect {
        self.layout_border_box() + self.paint_box_insets
    }

    /// Returns the widget's visual paint-box rect in the widget's border-box coordinate space.
    pub(crate) fn visual_paint_box(&self) -> Rect {
        self.visual_border_box + self.paint_box_insets
    }

    /// Returns the widget's visual content-box rect in the widget's border-box coordinate space.
    pub(crate) fn visual_content_box(&self) -> Rect {
        // Make sure we don't return a box with negative size.
